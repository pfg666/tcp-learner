...
public class InvlangRandomMapper extends InvlangMapper {
	...
	private List<Long> trouble = Collections.singletonList(0L);
	...
	public String processOutgoingReset() {
		...
		this.valuesOfInterest.remove(0L);
	...
	public String processOutgoingRequest(FlagSet flags, String absSeq,
		...
		while (this.valuesOfInterest.remove(0L));
		RangePicker picker = new RangePicker(random, 0, 0xffffffffL, this.valuesOfInterest, trouble);
