...
- the [FMICS/AVOCS 2017](https://paulfiterau.github.io/publications/2017-FMICS.pdf) publication which employs the Network Adapter component to test the windowing behavior of TCP stacks using RA model learning.
